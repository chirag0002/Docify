...
import { shareDocument, deleteShareDocument, checkPermissions } from "../controllers/document/shared/sharedDocument.controller";
...
router.get('/:documentId/permission/:userId', userAuthorization, checkPermissions)